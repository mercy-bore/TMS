...
public class ClientsList extends HttpServlet {
    public static void main(String[] args) throws Exception{
        ...
        ResultSet query_set = stmt.executeQuery("SELECT id,firstName,lastName,email,phone FROM customers");
        /* Step-2: Initialize PDF documents - logical objects */
        Document my_pdf_report = new Document();
        PdfWriter.getInstance(my_pdf_report, Files.newOutputStream(Paths.get("/home/mercy/Desktop/Reports/customer_report.pdf")));
        my_pdf_report.open();

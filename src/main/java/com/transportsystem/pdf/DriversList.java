...
public class DriversList extends HttpServlet {
    public static void main(String[] args) throws Exception{
        ...
        ResultSet query_set = stmt.executeQuery("SELECT id,firstName,lastName,email,phone FROM drivers");
        /* Step-2: Initialize PDF documents - logical objects */
        Document my_pdf_report = new Document();
        PdfWriter.getInstance(my_pdf_report, Files.newOutputStream(Paths.get("/home/mercy/Desktop/Reports/drivers_report.pdf")));
        my_pdf_report.open();
        Font bold = new Font(Font.FontFamily.HELVETICA, 18, Font.BOLD);
        Paragraph paragraph =new Paragraph("Report for Current Drivers List");
        ...
        while (query_set.next()) {
            ...
            String dept_name=query_set.getString("firstName");
            table_cell=new PdfPCell(new Phrase(dept_name));
            my_report_table.addCell(table_cell);
            String manager_id=query_set.getString("lastName");

...
<form action="./updatevehicle.jsp?plateNo=${vehicle.getPlateNo()}" method="post">
 <div class="bg-light rounded h-100 col-sm-12 col-xl-6">
                 ...
                 <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput"placeholder="Route" name="plateNo" value=${vehicle.getRoute()}>
